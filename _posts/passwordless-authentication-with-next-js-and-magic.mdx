---
path: nextjs-magic
coverImage: /assets/blog/nextjs-magic/cover.jpeg
publishDate: '2020-07-10T02:01:22.477Z'
...
The problem that the navigation display does not switch automatically after logging in can be solved by refetching using [Bound Mutate](https://swr.vercel.app/docs/mutation#bound-mutate).
