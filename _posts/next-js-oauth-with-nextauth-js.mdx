---
path: next-auth-app
coverImage: /assets/blog/next-auth-app/cover.jpeg
publishDate: '2020-07-20T05:34:03.436Z'
...
![Next Auth App](/assets/blog/next-auth-app/screenshot-2021-05-21-15.08.12.png 'Next Auth App')
...
If you want to use **Gmail** to send emails, see [Using Gmail - Nodemailer](http://nodemailer.com/usage/using-gmail/).
...
![Signed In with Google](/assets/blog/next-auth-app/screenshot-2021-05-21-18.44.11.png 'Signed In with Google')
...
![Sign In Failed](/assets/blog/next-auth-app/screenshot-2021-05-21-18.47.03.png 'Sign In Failed')
